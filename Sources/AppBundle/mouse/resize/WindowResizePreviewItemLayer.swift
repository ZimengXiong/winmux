...
final class WindowResizePreviewItemLayer: CALayer {
    ...
    private func updateTopBar(item: WindowResizePreviewItem, radius: CGFloat, scale: CGFloat) {
    ...
    private func fallbackLetter(icon: WindowResizePreviewIcon?, item: WindowResizePreviewItem) -> String {
